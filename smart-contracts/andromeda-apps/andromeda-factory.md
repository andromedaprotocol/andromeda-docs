...
Creates a new [ADO](../non-fungible-tokens/andromeda-digital-object.md) contract. The sender of the message is defined as the minter for the ADO contract and as such, the owner of the ADO contract.
...
| `token_code_id`   | Option\<u64> | Optional new code ID for the [ADO](../non-fungible-tokens/andromeda-digital-object.md) contracts.   |
