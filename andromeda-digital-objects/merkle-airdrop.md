...
| ---------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `asset_info`     | [Asset](broken-reference) | The assets to airdrop. Can be either a native token or a CW20.                                                                                                                                    |
...
| `expiration`   | Option<[Expiry](broken-reference)> | An optional expiration for the root. Defaults to never if not specified.                         |
...
| Name         | Type                      | Description        |
| ------------ | ------------------------- | ------------------ |
| `asset_info` | [Asset](broken-reference) | The type of Asset. |
...
| `expiration`   | [Expiration](broken-reference) | The expiration for the airdrop of this stage.                       |
