...
If `SetValue` uses a `key` that is already in use, the old `value` is overwritten by the latest `value.`
{% endhint %}
...
You can read more [here](broken-reference) about setting rates.
...
Queries the type of the value saved for the specified `key`.
...
| Name | Type            | Description                                                                                  |
| ---- | --------------- | -------------------------------------------------------------------------------------------- |
| key  | Option\<String> | The key for which we want to retrieve the type value. Defualts to the default key "default". |
...
| Name    | Type                         | Description                      |
| ------- | ---------------------------- | -------------------------------- |
| `owner` | [AndrAddr](broken-reference) | The address to get the keys for. |
