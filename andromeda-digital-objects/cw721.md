...
| `minter`  | [AndrAddress](../platform-and-framework/andromeda-digital-objects/common-types.md#andraddress) | The address of the token minter.                                                                                                                                          |
...
| Name        | Type                                                                                    | Description                                                               |
| ----------- | --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| `amount`    | Value<[Coin](../platform-and-framework/andromeda-digital-objects/common-types.md#coin)> | The amount required for the purchaser to transfer ownership of the token. |
...
| `expires`  | Option<[Expiration](../platform-and-framework/andromeda-digital-objects/common-types.md#expiration)> | An optional expiration for the approval                              |
...
| `expires` | [Expiration](../platform-and-framework/andromeda-digital-objects/common-types.md#expiration) | The expiration for the approval. |
...
| `expires` | [Expiration](../platform-and-framework/andromeda-digital-objects/common-types.md#expiration) | When the Approval expires. Might be Expiration::never. |
