...
| Name     | Type                                        | Description                            |
| -------- | ------------------------------------------- | -------------------------------------- |
| `access` | [OwnerOfResponse](cw721.md#ownerofresponse) | The owner of the ADO and any approvals |
| `info`   | [NFtInfoResponse](cw721.md#nftinforesponse) | The given ADO's stored information     |
