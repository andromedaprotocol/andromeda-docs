...
| `minter`  | [AndrAddress](../platform-and-framework/common-types.md#andraddress) | The address of the token minter.                                                                                                                                          |
...
| Name       | Type   | Description                   |
| ---------- | ------ | ----------------------------- |
| `token_id` | String | The id of the NFT to archive. |
...
| `token_id` | String                                                                     | The id of the NFT for which to assign the `spender` as an operator |
...
| Name        | Type             | Description                                                                    |
| ----------- | ---------------- | ------------------------------------------------------------------------------ |
| `token_uri` | String           | Universal resource identifier for this NFT.                                    |
