...
| `minter`         | [AndrAddr](broken-reference) | The address allowed to mint NFTs.                                                                                                                                                                 |
...
| Name        | Type                     | Description                                                               |
| ----------- | ------------------------ | ------------------------------------------------------------------------- |
| `amount`    | [Coin](broken-reference) | The amount required for the purchaser to transfer ownership of the token. |
...
| Name        | Type                         | Description                                   |
| ----------- | ---------------------------- | --------------------------------------------- |
| `recipient` | [AndrAddr](broken-reference) | The address to receive the NFT.               |
...
| Name       | Type                         | Description                                     |
| ---------- | ---------------------------- | ----------------------------------------------- |
| `contract` | [AndrAddr](broken-reference) | The address of the receiving contract.          |
...
| `expires`  | Option<[Expiration](broken-reference)> | An optional expiration for the approval. Defaults to never.           |
...
| `expires` | [Expiration](broken-reference) | The expiration for the approval. |
...
| `expires` | [Expiration](broken-reference) | When the Approval expires. Might be Expiration::never. |
