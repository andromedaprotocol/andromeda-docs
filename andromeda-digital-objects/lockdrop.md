...
This ADO is another part of the toolkit of allowing a user to setup their own [CW20 token](broken-reference). The lockdrop ADO allows users to deposit a native token in exchange for a given CW20 token.&#x20;
...
| ------------------- | ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `init_timestamp`    | [MillisecondsExpiration](broken-reference)                   | Timestamp in milliseconds till when deposits can be made.                                                                                                                                         |
| `deposit_window`    | [Milliseconds](broken-reference)[Duration](broken-reference) | Number of milliseconds for which lockup deposits will be accepted.                                                                                                                                |
| `withdrawal_window` | [Milliseconds](broken-reference)[Duration](broken-reference) | Number of milliseconds for which lockup withdrawals will be allowed. Cannot exceed the `deposit_window`.                                                                                          |
| `incentive_token`   | [AndrAddr](broken-reference)                                 | The CW20 token being given as incentive.                                                                                                                                                          |
