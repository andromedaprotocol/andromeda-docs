...
<table><thead><tr><th width="155.33333333333331">Name</th><th>Type</th><th>Description</th></tr></thead><tbody><tr><td><code>recipient</code></td><td>Option&#x3C;<a href="broken-reference">Recipient</a>></td><td>Optional recipient address. If not set, defaults to the sender.</td></tr><tr><td><code>condition</code></td><td>Option&#x3C;<a href="timelock.md#escrowcondition">EscrowCondition</a>></td><td>An optional condition to unlock the Escrow.</td></tr></tbody></table>
...
| -------------------- | ------------------------------------------ | --------------------------------------------------------------------------- |
| `Expiration`         | [MillisecondsExpiration](broken-reference) | Requires a given time to be reached. The time is specified in milliseconds. |
| `MinimumFunds`       | Vec<[Coin](broken-reference)>              | Requires a minimum amount of funds to be deposited.                         |
...
| Name        | Type                                                   | Description                                               |
| ----------- | ------------------------------------------------------ | --------------------------------------------------------- |
| `coins`     | Vec<[Coin](broken-reference)>                          | Funds being held within the Escrow.                       |
| `condition` | Option<[EscrowCondition](timelock.md#escrowcondition)> | Optional condition for the Escrow.                        |
| `recipient` | [Recipient](broken-reference)                          | The recipient of the funds once `condition` is satisfied. |
