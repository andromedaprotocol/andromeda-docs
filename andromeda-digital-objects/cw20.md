...
| Name        | Type                         | Description                            |
| ----------- | ---------------------------- | -------------------------------------- |
| `recipient` | [AndrAddr](broken-reference) | The address to transfer the tokens to. |
...
| `expires` | Option<[Expiration](broken-reference)> | Optional Expiration for the allowance of the spender.  |
...
| `expires`   | [Expiration](broken-reference) | The expiration for the tokens.                     |
...
| `expires`   | [Expiration](broken-reference) | The expiration for the allowance.      |
