...
The CW20 ADO is a smart contract to initiate a standard CW20 coin.&#x20;
...
| `expires` | Option<[Expiration](../platform-and-framework/andromeda-digital-objects/common-types.md#expiration)> | Optional Expiration for the allowance of the spender.  |
...
| `expires`   | [Expiration](../platform-and-framework/andromeda-digital-objects/common-types.md#expiration) | The expiration for the tokens.                     |
...
| `expires`   | [Expiration](../platform-and-framework/andromeda-digital-objects/common-types.md#expiration) | The expiration for the allowance.      |
...
</strong>  #[returns(cw20::AllSpenderAllowancesResponse)]
    AllSpenderAllowances {
        spender: String,
        start_after: Option&#x3C;String>,
        limit: Option&#x3C;u32>,
...
| Name          | Type            | Description                                                                                                   |
| ------------- | --------------- | ------------------------------------------------------------------------------------------------------------- |
| `spender`     | string          | The address we want to get the granted allowances for.                                                        |
| `start_after` | Option\<String> | An optional ID for which to start after, used for pagination.                                                 |
| `limit`       | Option\<u32>    | An optional limit to how many Accounts are returned. Set to 10 by default. Can be set up to a maximum of 30.  |
