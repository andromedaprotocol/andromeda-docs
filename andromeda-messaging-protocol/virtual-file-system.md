...
When an [Andromeda App](broken-reference) is made, it will register all paths for its child components and also register itself as a child of the instantiating address. Each component under the App is registered by its name, and the App itself is registered under its assigned name.
...
| ---------------- | --------------- | ------------------------------------------------------------------------------------------------------------ |
| `kernel_address` | String          | Address of the Kernel contract on chain. Can be found in our [deployed contracts](broken-reference).         |
...
| `parent_address` | Option<[AndrAddr](broken-reference)> | Optional address to specify as the parent for the component. If not specified, then the sender will be the parent by default. |
...
| `parent_address` | Option<[AndrAddr](broken-reference)> | The address to register the symlink under. |
...
| `parent_address` | [AndrAddr](broken-reference) | The address of the parent ADO. |
...
| Name   | Type                         | Description                      |
| ------ | ---------------------------- | -------------------------------- |
| `path` | [AndrAddr](broken-reference) | The path to get the address for. |
...
| Name    | Type                         | Description                                                                                    |
| ------- | ---------------------------- | ---------------------------------------------------------------------------------------------- |
| `path`  | [AndrAddr](broken-reference) | The path to get all sub directories for.                                                       |
...
| Name   | Type                         | Description                         |
| ------ | ---------------------------- | ----------------------------------- |
| `path` | [AndrAddr](broken-reference) | The path of the symlink to resolve. |
