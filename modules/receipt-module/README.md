...
The `Receipt` module creates a [receipt ](receipt-contract.md)contract to generate receipts that store the events activity.
...
More information on the Receipt contract can be found [here](receipt-contract.md).
