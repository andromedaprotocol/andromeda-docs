...
| Name            | Type                                                                     | Description                                                                                                                                                                                                     |
| --------------- | ------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `start_time`    | Option<[Expiry](../platform-and-framework/common-types.md#expiry)>       | Optional start time for the sale specified in milliseconds. Defaults to immediately if not specified.                                                                                                           |
