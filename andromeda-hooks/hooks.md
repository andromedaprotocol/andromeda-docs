...
{% hint style="info" %}
This function also ensures that the [`Receipt`](../ado-classes/receipt.md) module is invoked last if it exists, since it needs all of the previous events to create a complete receipt.
{% endhint %}
